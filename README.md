...
- Гид по пяти районам: отдельные сцены, утро/день/вечер, подбор по привычкам, сравнение двух зон и ссылки на карту и квартиры.
- Практические инструменты: четыре этапа переезда, чек-лист просмотра с сохранением в браузере, калькулятор первого месяца и депозита.
- Полезные материалы с фильтрами и переходом к инструменту; подробности подготовки объекта для собственников и сценарии жизни на странице «О нас».
...
| `npm run test:explore` | Подбор районов, бюджет и комплектность иллюстраций |
...
- [Девять новых сцен, точные промпты и источники гида](docs/editorial-assets.md)
